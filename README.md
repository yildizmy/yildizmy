...
<a href="#&"><img src="https://skillicons.dev/icons?i=java,kotlin,react,js,spring,hibernate,kafka,redis,git,github,gitlab,bitbucket,docker,openshift,jenkins,grafana,postgres,mysql,oracle,sqlserver,mongo,postman,gradle,maven,idea,vscode,&perline=12" /></a>
<br/>
